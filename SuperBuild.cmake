...
set(${LOCAL_PROJECT_NAME}_DEPENDENCIES ITKv4 SlicerExecutionModel)
...
#
# By default we want to build ${CMAKE_PROJECT_NAME} stuff using the CMAKE_BUILD_TYPE of
# the top level build, but build the support libraries in Release.
# So make one list of parameters to pass to ${CMAKE_PROJECT_NAME} when we build it and
...
set(${LOCAL_PROJECT_NAME}_EXTERNAL_PROJECT_ARGS ${${CMAKE_PROJECT_NAME}_SUPERBUILD_EP_ARGS})
...
ExternalProject_Add(${proj}
  ...
  CMAKE_ARGS
    ...
    ${${LOCAL_PROJECT_NAME}_EXTERNAL_PROJECT_ARGS}
